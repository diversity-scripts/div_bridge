...
Framework.GetJobAccountBalance = function(accountId)
    return 0, print('TMC does not provide a "GetJobAccountBalance" function')
end
...
Framework.AddJobAccountBalance = function(accountId, amount, reason)
    return false, print('TMC does not provide a "AddJobAccountBalance" function')
end
...
Framework.RemoveJobAccountBalance = function(accountId, amount, reason)
    return false, print('TMC does not provide a "RemoveJobAccountBalance" function')
end
