...
Framework.AddItem = function(source, itemName, itemCount, metadata, slot)
    return false, print('nd_core does not provide a "AddItem" function')
end
...
Framework.RemoveItem = function(source, itemName, itemCount, metadata, slot)
    return false, print('nd_core does not provide a "RemoveItem" function')
end
...
Framework.CanCarryItem = function(source, itemName, itemCount, metadata)
    return false, print('nd_core does not provide a "CanCarryItem" function')
end
...
Framework.GetItemCount = function(source, items)
    return 0, print('nd_core does not provide a "GetItemCount" function')
end
...
Framework.HasItem = function(source, items, itemCount)
    return false, print('nd_core does not provide a "HasItem" function')
end
...
Framework.GetItemData = function(source, itemName, metadata, slot)
    return {}, print('nd_core does not provide a "GetItemData" function')
end
...
Framework.GetItemByName = function(source, itemName, metadata, slot)
    return {}, print('nd_core does not provide a "GetItemByName" function')
end
...
Framework.GetItemBySlot = function(source, slot)
    return {}, print('nd_core does not provide a "GetItemBySlot" function')
end

---@param source number (unused)
---@return table
Framework.GetPlayerInventory = function(source)
    return {}, print('nd_core does not provide a "GetPlayerInventory" function')
end

---@param source number (unused)
Framework.ClearPlayerInventory = function(source)
    print('nd_core does not provide a "ClearPlayerInventory" function')
end
...
Framework.SetMetadata = function(source, slot, metadata)
    return {}, print('nd_core does not provide a "SetMetadata" function')
end

---@param itemName string (unused)
---@return string
Framework.GetItemlabel = function(itemName)
    return '', print('nd_core does not provide a "GetItemlabel" function')
end

---@param itemName? string (unused)
---@return table
Framework.Items = function(itemName)
    return {}, print('nd_core does not provide a "Items" function')
end
...
Framework.GetJobAccountBalance = function(accountId)
    return 0, print('nd_core does not provide a "GetJobAccountBalance" function')
end
...
Framework.AddJobAccountBalance = function(accountId, amount, reason)
    return false, print('nd_core does not provide a "AddJobAccountBalance" function')
end
...
Framework.RemoveJobAccountBalance = function(accountId, amount, reason)
    return false, print('nd_core does not provide a "RemoveJobAccountBalance" function')
end
